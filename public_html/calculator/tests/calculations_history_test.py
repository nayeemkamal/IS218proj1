...
"""
read csv file
dividebyzero=will write a logfile in logs folder with csv file with logged data : time, record. no - from pandas , error 
main function to start program  = put file in folder /calculationrecords
"""
@pytest.fixture
